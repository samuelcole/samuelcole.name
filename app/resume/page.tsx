      ...
      <div className={styles.frame}>
        <div className={styles.meta}>
          <div className={styles.metaFiles}>
            <span className={`${styles.tag} ${styles.tagActive}`}>web</span>
            <a
            ...
            <ol className={styles.entries}>
              ...
              <li className={styles.entry}>
                ...
                <div className={styles.body}>
                  ...
                  <p className={styles.desc}>
                    ...
                    donation-form server (Ruby Sinatra → Node; ops later lifted
                    it to AWS unchanged) and the company's PCI tokenizer. Solo,
                    built a new embed from scratch at{" "}
                    <strong>100% test coverage</strong>. Contributions scaled
                    from <strong>~$1B to over $8B</strong>. Embed powered the
                    Biden presidential campaign, the NAACP, Everytown, and more.
                  </p>
                </div>
              ...
              <li className={styles.entry}>
                ...
                <div className={styles.body}>
                  ...
                  <p className={styles.desc}>
                    ...
                    and faceting system, automated flight metadata, and
                    trip-level grouping. <em>Acquired by Emburse.</em>
                  </p>
                </div>
              ...
              <li className={styles.entry}>
                ...
                <div className={styles.body}>
                  ...
                  <p className={styles.desc}>
                    <strong>Employee #12</strong>, one of the first two
                    full-time engineers; joined pre-launch. Owned the client
                    side as Kickstarter scaled from $28M in annual pledges to{" "}
                    <strong>crossing $1B cumulative</strong> (March 2014), with
                    22,000+ projects funded in 2014 alone. Built the front-end
                    of the multistep project editor (still the basic shape of
                    today's flow), site search, custom text editors, creator
                    messaging / backer tools, admin tooling, and the first
                    mainstream HTML5 video player.
                  </p>
                </div>
              ...
              <li className={styles.entry}>
                ...
                <div className={styles.body}>
                  ...
                  <p className={styles.desc}>
                    ...
                    name. Built the CMS and front-end architecture that scaled
                    to{" "}
                    <strong>
